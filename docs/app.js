...
function fetchContent404() {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(_dom_1.resolveUrl(`./${config_1.FRONT_PAGES_FOLDER}/error404.html`));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (response.status !== 200) {
                const html = yield fetchContent404();
...
function playHtml(playground, action) {
    ...
    const wrap = _dom_1.wrapNode(playground, 'app-playground-demo');
    ...
    const playAction = _dom_1.createNode(`<a href="#" class="app-playground__action">${content} ${icon}</a>`);
